---
id: index-basic-redis-caching-example-in-nodejs
title: Basic Redis caching example in Nodejs
sidebar_label: Basic Redis caching example in Nodejs
slug: /marketplace/basic-redis-caching-example-in-nodejs
---
