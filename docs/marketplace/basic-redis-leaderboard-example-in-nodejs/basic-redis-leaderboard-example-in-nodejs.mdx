---
id: index-basic-redis-leaderboard-example-in-nodejs
title: Basic Redis leaderboard example in Nodejs
sidebar_label: Basic Redis leaderboard example in Nodejs
slug: /marketplace/basic-redis-leaderboard-example-in-nodejs
---
